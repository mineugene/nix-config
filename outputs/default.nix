...
let
    ...
    gtk4ThemeCompatibilityCheck = import ../tests/gtk4-theme.nix {
        ...
        gtk4Css = hyprlandLegacyGtk4ThemeConfiguration.config.xdg.configFile."gtk-4.0/gtk.css" or null;
    ...
    shellScriptsCheck = import ../tests/shell-scripts.nix {
        pkgs = nixpkgs.legacyPackages.${system};
        src = self;
    };
    ...
    gitScriptsCheck = import ../tests/git-scripts.nix {
        pkgs = nixpkgs.legacyPackages.${system};
        homePackages = publicModuleConfiguration.config.home.packages;
    };

    yubikeyTouchNotifyCheck = import ../tests/yubikey-touch-notify.nix {
        pkgs = nixpkgs.legacyPackages.${system};
    ...
    checks.${system} = {
        ...
        shell-scripts = shellScriptsCheck;
