...
local volume_up = programs.eww_audio and (programs.eww_audio .. " change-sink up")
    or (programs.wpctl .. " set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+")
local volume_down = programs.eww_audio and (programs.eww_audio .. " change-sink down")
    or (programs.wpctl .. " set-volume @DEFAULT_AUDIO_SINK@ 5%-")
local toggle_sink = programs.eww_audio and (programs.eww_audio .. " toggle-sink")
    or (programs.wpctl .. " set-mute @DEFAULT_AUDIO_SINK@ toggle")
local toggle_source = programs.eww_audio and (programs.eww_audio .. " toggle-source")
    or (programs.wpctl .. " set-mute @DEFAULT_AUDIO_SOURCE@ toggle")
...
hl.bind("XF86AudioMute", hl.dsp.exec_cmd(toggle_sink), {
    locked = true,
})
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd(toggle_source), {
    locked = true,
})
